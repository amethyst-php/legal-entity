...
class LegalEntityContactDeletedAtNotDefinedException extends LegalEntityContactAttributeException
{
    /**
     ...
     * @var string
     */
    protected $code = 'LEGAL_ENTITY_CONTACT_DELETED_AT_NOT_DEFINED';
