...
class LegalEntityContactValueNotAuthorizedException extends LegalEntityContactAttributeException
{
    /**
     ...
     * @var string
     */
    protected $code = 'LEGALENTITYCONTACT_VALUE_NOT_AUTHTORIZED';
