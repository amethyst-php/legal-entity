...
class LegalEntityContactLegalEntityIdNotDefinedException extends LegalEntityContactAttributeException
{
    /**
     ...
     * @var string
     */
    protected $code = 'LEGAL_ENTITY_CONTACT_LEGAL_ENTITY_ID_NOT_DEFINED';
