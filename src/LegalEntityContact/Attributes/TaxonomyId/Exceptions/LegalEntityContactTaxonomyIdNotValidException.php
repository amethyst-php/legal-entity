...
class LegalEntityContactTaxonomyIdNotValidException extends LegalEntityContactAttributeException
{
    /**
     ...
     * @var string
     */
    protected $code = 'LEGAL_ENTITY_CONTACT_TAXONOMY_ID_NOT_VALID';
